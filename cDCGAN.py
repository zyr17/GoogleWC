...
class discriminator(nn.Module):
    ...
    def __init__(self, d=128):
        ...
        self.conv1_1 = nn.Conv2d(1, d/2, 4, 2, 3)
        self.conv1_2 = nn.Conv2d(10, d/2, 4, 2, 3)
...
x, y = loadquickdrawdata(10000)
train_loader = torch.utils.data.DataLoader(
    torch.utils.data.TensorDataset(torch.tensor(x).float(), torch.tensor(y).long()),
...
for epoch in range(train_epoch):
    ...
    for x_, y_ in train_loader:
        ...
        #print(torch.min(x_), torch.max(x_))
